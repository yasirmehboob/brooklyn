                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <div class="col-md-2 pull-right top_search" style="margin-bottom:0;">
                                    ...
                                    <div class="col-md-12">
                                        <a href="content.php?t=<?php echo $t_name;?>"><button type="button" class="btn btn-success cap" style="width:100%;"><i class="fa fa-plus"></i> New <?php echo $t_name;?></button></a>                                            
                                    </div>
                                        <!--Filter Buttion-->
                                </div>
                                ...
                                <div class=\"form-group\">
                                  ...
                                  <div class=\"col-md-6 col-sm-6 col-xs-12\">";
                                    ...
                                    if($count_fk>0){//if forigen key found
                                            ...
                                            $sql_fk_ref = "select distinct(".$fk['referenced_column_name'].") from ". $fk['referenced_table_name'];
