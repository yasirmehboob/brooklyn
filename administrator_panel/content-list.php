                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <div class="col-md-4 form-group pull-right top_search" style="margin-bottom:0;">
                                        <!--Filter Buttion-->
                                        <form action="content-list.php?t=<?php echo $t_name;?>" method="post">
                                            <div class="col-md-5">
                                            ...
                                            <div class="col-md-3">
                                                <a href="content.php?t=<?php echo $t_name;?>"><button type="button" class="btn btn-primary cap"><i class="fa fa-plus"></i> New <?php echo $t_name;?></button></a>                                            
                                            </div>
                                        </form>
                                        <!--Filter Buttion-->
                                </div>
                                                ...
                                                while($ed_desc=mysql_fetch_array($ed_desc_query)){
                                                    ...
                                                    if(1==1){//exampt some fields           
                                                        ...
                                                        $count_fk = mysql_num_rows(mysql_query($sql_fk));
                                                            ...
                                                            if($count_fk>0){//if forigen key found
                                                                ...
                                                                print"<td>".html_entity_decode($fk_dropdown_val)."</td>";   
                                                 ...
                                                 print "
                                                    <td style=\"text-align:center\">
                                                        ...
                                                        <a href=\"content-edit.php?id=".$result['id']."&t=".$t_name."\" class=\"btn btn-info btn-xs\"><i class=\"fa fa-pencil\"></i> Edit </a>
