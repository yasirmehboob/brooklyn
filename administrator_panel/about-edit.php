...
<body class="nav-md">
            ...
            <div class="right_col" role="main">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Edit About's Page Content</h2>
                                <div class="col-md-3 form-group pull-right top_search" style="margin-bottom:0;">
                                        <a href="about.php" style="float:right"><button type="button" class="btn btn-danger"><i class="fa fa-ban"></i> Cancle</button></a> 
                                    
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <form id="form" class="form-horizontal form-label-left" action="admin/ajax/php/up.php?t_name1=about&count=1&row=single&file=false&flimit=0&aiu=n&log=n" method="POST">
                                    ...
                                    <textarea id="descp" name="descp" class="element textarea large">
                                        <?php 
                                            ...
                                            print html_entity_decode($about['descp']);
                                        ?>
                                    </textarea>
    ...
    <script src="admin/ajax/js/about.js"></script>
