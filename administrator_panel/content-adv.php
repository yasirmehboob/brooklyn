                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <div class="col-md-2 pull-right top_search" style="margin-bottom:0;">
                                    ...
                                    <div class="col-md-12">
                                        <a href="content-adv-list.php?t=<?php echo $t_name;?>"><button type="button" class="btn btn-success cap" style="width:100%;"><i class="fa fa-list"></i> View All <?php echo $t_name;?></button></a>                                            
                                    </div>
                                        <!--Filter Buttion-->
                                </div>
                            ...
                            <div class="x_content">
                                <form id="form" class="form-horizontal form-label-left" action="admin/ajax/php/sv_img.php?t_name=<?php echo $_GET['t'];?>" method="post">
                                ...
                                <div class="ln_solid"></div>
                                    <div class="form-group">
                                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            ...
                                            <input type="hidden" value="../../../images/<?php echo $t_name;?>/" name="path" />
                                            <a href="content-adv-list.php?t=<?php echo $t_name;?>"><button type="button" class="btn btn-primary">Cancel</button></a>
