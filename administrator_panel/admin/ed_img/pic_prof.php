						  ...
						  <div>	
                            ...
                            <td width="40">Edit</td><td width="40">Delete</td></tr>
								...
								print"<tr id=\"fix_height\">";
										...
										<td><div>"; echo $ed_data['img']; print "</div></td>
										...
										print "
										<a href=\"../../images/contestants/";echo $ed_data['img']; print"\" >
										<img src=\"../../images/contestants/";echo $ed_data['img']; print"\" width=\"60\" height=\"35\" alt=\"uploaded image\" />
										</a>
										</div></td>
										
										<td><a href=\"ed_data_prof.php?id=";echo $ed_data['id']; print "&t_name="; 
								echo $t_name; print "&img="; 
								echo $ed_data['img']; print"&name="; echo $ed_data['name']; print"\"><img src=\"../menu/images/modify.png\" width=\"24\" height=\"24\" alt=\"Edit\" /></a></td>
