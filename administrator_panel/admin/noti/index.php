...
<title>post noti65</title><link rel="stylesheet" media="screen and (min-width: 1274px) and (max-width: 1285px)" type="text/css" href="../c-libs/screen/1280-1024.css"><link rel="stylesheet" media="screen and (min-width: 1440px) and (max-width: 1680px)" type="text/css" href="../c-libs/screen/1440.css">
	...
	function getTable() {
		...
		foreach ($db->get_users() as $value) {
			...
			$data .='<tr style="background:'.$bg.'">
			    ...
			    <td><span class="tb">'.$value['noti_detail'].'</span></td>
				<td><span class="tb">'.$value['noti_short'].'</span></td>
				<td><span class="tb">'.$value['post_by'].'</span></td>
				<td><span class="tb">'.$value['img_sml'].'</span></td>
				<td><span class="tb">'.$value['img_lrg'].'</span></td>
				<td><span class="tb">'.$value['noti_position'].'</span></td>
				<td align="center">
		...
		$data .='</tbody>
			...
			<div id="paginator">'.$db->paginate(). ' </br> <a href="../forms/post_noti.php" id="link">Post Notification</a></div>';
		return $data;
	}
