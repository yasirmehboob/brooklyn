            ...
            <div class="right_col" role="main">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2 class="cap"><?php echo $t_name;?> List</h2>
                                <div class="col-md-4 form-group pull-right top_search" style="margin-bottom:0;">
                                        <!--Filter Buttion-->
                                        <form action="content-adv-list.php?t=<?php echo $t_name;?>" method="post">
                                            <div class="col-md-5">
                                            ...
                                            <div class="col-md-3">
                                                <?php 
                                                    if($t_name=='announcement'){
                                                        $link='announcemnts.php?t='.$t_name;
                                                    }else{
                                                        $link='content-adv.php?t='.$t_name;
                                                    }
                                                ?>
                                                <a href="<?php echo $link;?>"><button type="button" class="btn btn-primary cap"><i class="fa fa-plus"></i> New <?php echo $t_name;?></button></a>                                            
                                            </div>
                                        </form>
                                        <!--Filter Buttion-->
                                </div>
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $sql_data='select * from '. $t_name .$where. $order;
                                            ...
                                            while($result=mysql_fetch_array($query)){
                                                ...
                                                $ed_desc_query=mysql_query($sql);
                                                    ...
                                                    print "<tr>";
                                                        ...
                                                        while($ed_desc=mysql_fetch_array($ed_desc_query)){
                                                            if($ed_desc['Field']=='files_1'){
                                                        $result['files_1']="<ul class=\"list-inline\">
                                                                            <li>
                                                                              <a href=\"images/".$result['dir'].'/'.$result['files_1']."\" data-toggle=\"lightbox\" data-title=\"".$t_name.' ('.$result['id'].")\" data-footer=\"".$t_name.' ('.$result['id'].") \")>
                                                            ...
                                                            if($ed_desc['Field']!='dir'){//exampt some fields    
                                                                ...
                                                                //for ($i = 0; $i < mysql_num_fields($query_fk_ref); $i++) { // getting all columns
                                                                    ...
                                                                    print"<td>"; echo html_entity_decode($result[$ed_desc['Field']]); print "</td>";   
                                                                }
                                                                
                                                            }//End exampt some fields    
                                                        };
                                                         print "
                                                            <td style=\"text-align:center\">
                                                                <a href=\"content-adv-edit.php?id=".$result['id']."&t=".$t_name."\" class=\"btn btn-info btn-xs\"><i class=\"fa fa-pencil\"></i> Edit </a>
