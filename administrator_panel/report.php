            ...
            <div class="right_col" role="main">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>New Report Privilage</h2>
                                <div class="col-md-3 form-group pull-right top_search" style="margin-bottom:0;">
                                        <a href="report-list.php" style="float:right"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> View Report List</button></a>                                            
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <form id="form" class="form-horizontal form-label-left" action="admin/ajax/php/sv.php?t_name1=ornasys_rep&count=1&row=single&file=false&flimit=0&aiu=n&log=n" method="POST">
                                    <div class="col-md-12" style="margin-bottom:0.5em;">

                                        <div class="col-md-3">
                                            <label class="control-label">Report File Name</label>
                                            <input type="text" required placeholder="File Name" class="form-control" name="rep_nm">
                                        </div>
                                        
                                        <div class="col-md-3">
                                            <label class="control-label">Display Name</label>
                                            <input type="text" placeholder="Navigation Name" class="form-control" name="display_name">
                                        </div>
                                        
                                        
                                        <div class="col-md-3">
                                            <label class="control-label">Sort</label>
                                            <input type="number" min="0" required placeholder="sort" class="form-control" name="sort">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12" style="margin-top:1em;">
                                            ...
                                            <input type="hidden" name="reg_id" value="N/A">
