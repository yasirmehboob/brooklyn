		...
		<form id="form_806184" class="appnitro"  method="post" action="../orna/ins-type.php">
			...
			<ul >
					...
					<li id="li_2" >
                          ...
                          <?php
						  		$sql='SELECT * FROM  ornasys_tbl';
						  		$ed_list_query=mysql_query($sql);
								while($ed_list=mysql_fetch_array($ed_list_query)){
								print"<tr id=\"fix_height\">
								<td><div><a href=\"ed_table.php?t_name="; echo $ed_list['tname_db']; print "\">"; 
								echo $ed_list['display_name']; print"</a></div></td>
								</tr>";
								}
							?>
