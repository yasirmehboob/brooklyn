...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Add File</a></h1>
		<form id="form_841875" class="appnitro"  method="post" action="../orna/ins-file.php">
			...
			<ul >
					...
					<li id="li_2" >
		<label class="description" for="rack_id">Select Rack </label>
		<div>
		<select class="element select medium" id="rack_id" name="rack_id" required x-moz-errormessage=""> 
		...
		<label class="description" for="file_nm">FIle Name </label>
		<div>
			<input id="file_nm" name="file_nm" class="element text medium" type="text" maxlength="255" value="" required x-moz-errormessage=""/> 
		</div> 
		</li>
