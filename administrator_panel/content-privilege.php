            ...
            <div class="right_col" role="main">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2 class="cap">New Content Privilege</h2>
                                <div class="col-md-3 pull-right top_search" style="margin-bottom:0;">
                                        
                                    <div class="col-md-12">
                                        <a href="content-privilege-list.php?t=<?php echo $t_name;?>"><button type="button" class="btn btn-success cap" style="width:100%;"><i class="fa fa-list"></i> View All Content Privilege</button></a>                                            
                                    </div>
                                        <!--Filter Buttion-->
                                </div>
                            ...
                            <div class="x_content">
                                <form id="form" class="form-horizontal form-label-left" action="admin/ajax/php/sv.php?t_name1=ornasys_tbl&count=1&row=single&file=false&flimit=0&aiu=n&log=n" method="POST">
                                  ...
                                  <div class=\"col-md-6 col-sm-6 col-xs-12\">";
                                    ...
                                    if($count_fk>0){//if forigen key found
                                            ...
                                            while($fk_ref = mysql_fetch_array($query_fk_ref)){
                                                ...
                                                $fk_dropdown_val= '';
                                                for ($i = 0; $i < mysql_num_fields($query_fk_data); $i++) {
                                        ...
                                        print "</select>";
                                            ...
                                            print"
                                            <textarea class=\"form-control\" rows=\"4\" name=\""; echo stripslashes($ed_desc['Field']); print "\"></textarea>";
                                            }
                                ...
                                <div class="ln_solid"></div>
                                    <div class="form-group">
                                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            ...
                                            <input type="hidden" id="table" value="ornasys_tbl">
