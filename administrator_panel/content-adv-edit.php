...
<head>
    ...
    <title>Edit <?php echo $t_name;?></title>
...
<body class="nav-md">
            ...
            <div class="right_col" role="main">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2 class="cap">Edit Content (<?php echo $t_name;?>)</h2>
                                <div class="col-md-2 pull-right top_search" style="margin-bottom:0;">
                                        
                                    <div class="col-md-12">
                                        <a href="content-adv.php?t=<?php echo $t_name;?>"><button type="button" class="btn btn-success cap" style="width:100%;"><i class="fa fa-plus"></i> New <?php echo $t_name;?></button></a>                                            
                                    </div>
                                        <!--Filter Buttion-->
                                </div>
                            ...
                            <div class="x_content">
                                <!--Current Image-->
                                    <div class="avatar-view" title="Current Image">
                                        <p style="text-align:center;"> Current Image</p>
                                      <img class="current_img" src="images/loading1.gif" alt="Current Image">
                                    </div>
                                <!--Current Image-->
                                
                                <form id="form" class="form-horizontal form-label-left" action="admin/ajax/php/up_img.php?t_name1=<?php echo $_GET['table'];?>" method="POST">
                            ...
                            if($ed_desc['Field']!='dir'){//skiping some fields
                                ...
                                <div class=\"form-group\">
                                  <label class=\"control-label col-md-3 col-sm-3 col-xs-12 cap\" for=\"".stripslashes($ed_desc['lable'])."\">"; echo $ed_desc['lable']; print" <span class=\"required\">*</span>
                                  </label>
                                  <div class=\"col-md-6 col-sm-6 col-xs-12\">";
                                    ...
                                    if($count_fk>0){//if forigen key found
                                            ...
                                            while($fk_ref = mysql_fetch_array($query_fk_ref)){
                                                if($fk_ref[$fk['referenced_column_name']]==$ed_data[$ed_desc['Field']]){
                                                    $select = ' selected ';
                                                }else{
                                                    $select = '';}

                                                //making forigen key values for drop-down
                                                $sql_fk_data = $sql_fk_ref. " where id = '".$fk_ref['id']."'";
                                               ...
                                               //making forigen key values for drop-down    
                                                ...
                                                print "<option value=\"".$fk_ref[$fk['referenced_column_name']]."\" ".$select.">".$fk_dropdown_val."</option>";
                                            }//end While Fk-Ref 
                                        print "</select>";
                                            ...
                                            print"
                                            <textarea class=\"form-control\" id=\"descp\" rows=\"4\" name=\""; echo stripslashes($ed_desc['Field']); print "\">"; echo $ed_data[$ed_desc['Field']]; print"</textarea>";
                                            }

                                            else if($ed_desc['Field']=='dt'){
                                                //managing Date Formate
                                                if(is_numeric($ed_data[$ed_desc['Field']])){
                                                 $dt = $ed_data[$ed_desc['Field']];   
                                                }else{
                                                  $dt =strtotime($ed_data[$ed_desc['Field']]);
                                                }
                                                //managing Date Formate
                                                
                                                print"
                                                    <input type=\"date\" class=\"form-control\" value=\""; echo date('Y-m-d',$dt); print"\" name=\""; echo stripslashes($ed_desc['Field']); print "\"/>";
                                                }

                                            else if($ed_desc['Field']=='id'){
                                                    print"<input class=\"form-control\" type=\"text\" value=\""; echo $ed_data[$ed_desc['Field']]; print"\" name=\""; echo stripslashes($ed_desc['Field']); print "\" readonly/>";
                                                }

                                            else if($ed_desc['Field']=='del'){
                                                if($ed_data[$ed_desc['Field']]=='N'){
                                                    $s1 = " selected ";
                                                    $s2 = "";
                                                }else{
                                                    $s1 = "";
                                                ...
                                                print"
                                                    <select  class=\"form-control\" name=\"".stripslashes($ed_desc['Field'])."\">
                                                        <option value=\"N\" ".$s1.">Active</option>
                                                        <option value=\"Y\" ".$s2.">In-Active</option>
                                                    </select>";
                                                }    

                                                else if($ed_desc['Field']=='files_1'){
                                                        print"<input  type=\"file\" name=\""; echo stripslashes($ed_desc['Field']); print"\" id=\"uploadImage\" accept=\"image/jpeg\" required  class=\"form-control\"/>
                                                            <!-- hidden inputs -->
                                                    ...
                                                    print"<input class=\"form-control\" type=\"text\" value=\""; echo $ed_data[$ed_desc['Field']]; print"\" name=\""; echo stripslashes($ed_desc['Field']); print "\"/>";
                                                    }
                                ...
                                <div class="ln_solid"></div>
                                    <div class="form-group">
                                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            ...
                                            <input type="hidden" id="table" value="<?php echo $_GET['t']?>" name="table">
                                            <a href="content-adv-list.php?t=<?php echo $_GET['t']?>"><button type="button" class="btn btn-danger">Cancel</button></a>
                                            <button type="submit" id="up" class="btn btn-primary">Update</button>
                                      </div>
                                    </div>   
                                </form>
                            </div>
    ...
    <script src="admin/ajax/js/update_img.js"></script>
