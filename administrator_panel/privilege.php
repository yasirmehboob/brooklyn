                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <div class="col-md-3 form-group pull-right top_search" style="margin-bottom:0;">
                                        <a href="privilege-list.php" style="float:right"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> View Privileges List</button></a>                                            
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <form id="form" class="form-horizontal form-label-left" action="admin/ajax/php/sv.php?t_name1=ornasys_mnu&count=1&row=single&file=false&flimit=0&aiu=n&log=n" method="POST">
                                    <div class="col-md-12" style="margin-bottom:0.5em;">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" placeholder="Forder Path from Root" class="form-control" name="folder">
                                        </div>
