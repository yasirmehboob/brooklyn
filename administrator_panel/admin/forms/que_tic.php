...
<title>Ticket Reservation APPLICATIONS -<?php echo $company;?></title>
...
<form id="form_806184" class="appnitro"  method="post" action="../orna/ins-type.php">
    <div class="form_description">
        <h2>Ticket Reservation's Applications	
        ...
        <li id="li_2" >
          <div>	
            ...
            <tr style="background-color:#ccc;">
                ...
                <td width="100"><strong>Ticktes</strong></td>
                <td width="350"><strong>Remarks</strong></td>
                <td width="30"><strong>Delete</strong></td>
             </tr>
             
             <?php
             $sql="select * from ticket $where order by id";
			 ...
			 print "<tr class=\"";echo $status['active'];print"\">
					...
					<td width=\"300\"> <a href=\"#\">";echo $status['name']; print "</a></td>
					...
					<td width=\"100\">";echo $status['tickets_no']; print "</td>
					<td width=\"350\">";echo $status['remarks']; print "</td>
