                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <div class="col-md-4 form-group pull-right top_search" style="margin-bottom:0;">
                                        <!--Filter Buttion-->
                                        <form action="privilege-list.php" method="post">
                                            <div class="col-md-5">
                                            ...
                                            <div class="col-md-3">
                                                <a href="privilege.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> New Privilege</button></a>                                            
                                            </div>
                                        </form>
                                        <!--Filter Buttion-->
                                </div>
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $sql="select * from ornasys_mnu".$where. " order by f_nm";
                                            ...
                                            while($result=mysql_fetch_array($query)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href=\"privilege-edit.php?id=".$result['id']."&table=ornasys_mnu\" class=\"btn btn-info btn-xs\"><i class=\"fa fa-pencil\"></i> Edit </a>

                                                        <button type=\"button\" class=\"btn btn-danger btn-xs delete\" data-toggle=\"modal\" data-target=\"#delete-modal\"
                                                        data-id=\"".$result['id']."\" data-name=\"".$result['f_nm']."\"  data-tname=\"ornasys_mnu\">
