...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Management Team</a></h1>
		<form id="form_895435" class="appnitro" enctype="multipart/form-data" method="post" action="../orna/ins-manag.php">
					<div class="form_description">
			<h2>Upload Management Team</h2>
