...
elseif($_GET['row']=="multi"){
	...
	$sql_update_mast="update session_m set status='active' where id='".$_POST['session_m_id'][0]."'";
	mysql_query($sql_update_mast);
	
	//Delete old trans data before inserting new data
	$sql_delete_trans="delete from session_t where session_m_id='".$_POST['session_m_id'][0]."'";
