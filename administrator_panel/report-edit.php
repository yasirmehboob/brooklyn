                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <div class="col-md-2 form-group pull-right top_search" style="margin-bottom:0;">
                                    <a href="privilege-list.php" style="float:right;"><button type="button" class="btn btn-primary"><i class="fa fa-list"></i> View All Privileges</button></a>
                                </div>
                                <div class="col-md-2" style="float:right">
                                    <select class="form-control active_status" name="del">
                                ...
                                <form id="form" class="form-horizontal form-label-left" action="admin/ajax/php/up.php?t_name1=<?php echo $_GET['table'];?>&count=1&row=single&file=false&flimit=0&aiu=n&log=n" method="POST">
                                    <div class="col-md-12" style="margin-bottom:0.5em;">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" required placeholder="Navigation Name" class="form-control" name="f_nm">
                                        </div>
                                        
                                        <div class="col-md-3">
                                            <label class="control-label">Folder Path</label>
                                            <input type="text" required placeholder="Forder Path from Root" class="form-control" name="folder">
                                        </div>
                                        
                                        
                                        <div class="col-md-3">
                                            <label class="control-label">Form Name</label>
                                            <input type="text" required placeholder="Form Link" class="form-control" name="f_lnk">
                                        </div>
                                        
                                        
                                        <div class="col-md-3">
                                            <label class="control-label">Sort</label>
                                            <input type="number" required placeholder="Sort Order" class="form-control" name="sort">
                                        </div>
                                        
                                        
                                        <div class="col-md-3">
                                            <label class="control-label">Access To User</label>
                                            <select required class="form-control" name="user">
                                            <?php
                                                $query_user = mysql_query("select * from cms_users");
                                        ...
                                        <!-- own select -->
                                        <select id="icons-fa" class="form-control fa-select" name="icon">
                                        ...
                                        <div class="col-md-1">
                                            <span id="view-fa" style="font-size:2em; margin-top: 1em;display: block;font-weight:bold"></span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12" style="margin-top:1em;">
                                            ...
                                            <button type="button" id="up" class="btn btn-success">Update</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
