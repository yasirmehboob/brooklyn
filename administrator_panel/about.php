            ...
            <div class="right_col" role="main">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>About's Page Content</h2>
                                <div class="col-md-3 form-group pull-right top_search" style="margin-bottom:0;">
                                        <a href="about-edit.php" style="float:right"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Edit This Page</button></a>                                            
                                </div>
